...
public abstract class MPDResponsePartitionList extends MPDResponseHandler {

    public MPDResponsePartitionList() {
     ...
     * @param partitionList
     */
    public void sendPartitions(List<MPDPartition> partitionList) {
        Message responseMessage = this.obtainMessage();
        responseMessage.obj = partitionList;
